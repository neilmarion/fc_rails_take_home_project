...
Style.create(name: "Collegno Diamond Print Drawstring Waist Dress",
             type: "Dress",    wholesale_price: 18, retail_price: 80, floor_price_sold: 5).tap { |style|
  make_items(style,"Orange")
  make_items(style,"Green")
}
Style.create(name: "Pomelo Critter Print Maxi Dress",
             type: "Dress",    wholesale_price: 6, retail_price: 80, floor_price_sold: 5).tap { |style|
  make_items(style,"Orange")
  make_items(style,"Green")
}
Style.create(name: "Leah Straight Leg Cuffed Jean",
             type: "Pants",    wholesale_price: 34, retail_price: 90, floor_price_sold: 5).tap { |style|
...
Style.create(name: "Blue Camo Print Boyfriend Jeans",
             type: "Pants",    wholesale_price: 5, retail_price: 70, floor_price_sold: 5).tap { |style|
  make_items(style,"Navy")
}
